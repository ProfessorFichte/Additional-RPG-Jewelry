        ...
        if(FabricLoader.getInstance().isModLoaded(WITCHER)){
            ...
            add(new Identifier(AdditionalJewelry.MOD_ID,"steel_jade_ring"),Rarity.UNCOMMON, new ItemConfig.Item(
                    List.of(
                            new ItemConfig.AttributeModifier(Objects.requireNonNull(
                                    Identifier.tryParse("witcher_rpg:adrenaline_modifier")),
                                    0.08F , EntityAttributeModifier.Operation.MULTIPLY_BASE),
            ...
            add(new Identifier(AdditionalJewelry.MOD_ID, "dark_steel_jade_ring"), Rarity.UNCOMMON, new ItemConfig.Item(
                    List.of(
                            new ItemConfig.AttributeModifier(Objects.requireNonNull(
                                    Identifier.tryParse("witcher_rpg:adrenaline_modifier")),
                                    0.14F , EntityAttributeModifier.Operation.MULTIPLY_BASE),
                            new ItemConfig.AttributeModifier("generic.attack_damage", tier_2_multiplier/2, EntityAttributeModifier.Operation.MULTIPLY_BASE)
                    )
            ));
            ...
            add(new Identifier(AdditionalJewelry.MOD_ID, "bear_school_medallion"), Rarity.RARE, true ,new ItemConfig.Item(
                    List.of(
                            new ItemConfig.AttributeModifier(Objects.requireNonNull(
                                    Identifier.tryParse("witcher_rpg:quen_intensity")),
            ...
            add(new Identifier(AdditionalJewelry.MOD_ID, "cat_school_medallion"), Rarity.RARE, true ,new ItemConfig.Item(
                    List.of(
                            new ItemConfig.AttributeModifier(Objects.requireNonNull(
                                    Identifier.tryParse("witcher_rpg:aard_intensity")),
                                    2 , EntityAttributeModifier.Operation.ADDITION),
                            new ItemConfig.AttributeModifier("generic.attack_speed", 0.06F, EntityAttributeModifier.Operation.MULTIPLY_BASE),
                            new ItemConfig.AttributeModifier(Objects.requireNonNull(
                                    Identifier.tryParse("witcher_rpg:adrenaline_modifier")),
                                    0.2F , EntityAttributeModifier.Operation.MULTIPLY_BASE),
                            new ItemConfig.AttributeModifier("generic.attack_damage", tier_3_physical_multiplier,
                                    EntityAttributeModifier.Operation.MULTIPLY_BASE)
                    )
            ));
            add(new Identifier(AdditionalJewelry.MOD_ID, "griffin_school_medallion"), Rarity.UNCOMMON, new ItemConfig.Item(
                    List.of(
                            new ItemConfig.AttributeModifier(Objects.requireNonNull(
                                    Identifier.tryParse("witcher_rpg:sign_intensity")),
                                    tier_3_spell_multiplier , EntityAttributeModifier.Operation.MULTIPLY_BASE),
                            new ItemConfig.AttributeModifier(Objects.requireNonNull(
                                    Identifier.tryParse("witcher_rpg:adrenaline_modifier")),
                                    0.12F , EntityAttributeModifier.Operation.MULTIPLY_BASE),
                            new ItemConfig.AttributeModifier(SpellPowerMechanics.CRITICAL_DAMAGE.id, tier_3_secondary_multiplier, EntityAttributeModifier.Operation.MULTIPLY_BASE),
                            new ItemConfig.AttributeModifier(SpellPowerMechanics.HASTE.id, tier_3_secondary_multiplier, EntityAttributeModifier.Operation.MULTIPLY_BASE)
                    )
            ));
            add(new Identifier(AdditionalJewelry.MOD_ID, "wolf_school_medallion"), Rarity.UNCOMMON, new ItemConfig.Item(
                    List.of(
                            new ItemConfig.AttributeModifier(Objects.requireNonNull(
                                    Identifier.tryParse("witcher_rpg:sign_intensity")),
                                    tier_3_spell_multiplier , EntityAttributeModifier.Operation.MULTIPLY_BASE),
